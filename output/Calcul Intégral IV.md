...
`\addcontentsline{toc}{paragraph}{Monotonie}`{=latex}
...
`\addcontentsline{toc}{subsubsection}{Intégrales finies, infinies et indéfinies}`{=latex}
...
`\addcontentsline{toc}{paragraph}{Singletons de \(\mathbb{N}\)}`{=latex}
...
::: {.section}
#### Exercice -- Tribu engendrée par une collection finie {#tribu-engendrée-par-une-collection-finie .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Tribu engendrée par une collection finie}`{=latex}
...
::: {.section}
#### Exercice -- Tribu engendrée par les ensembles dénombrables {#tribu-engendrée-par-les-ensembles-dénombrables .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Tribu engendrée par les ensembles dénombrables}`{=latex}
...
::: {.section}
#### Exercice -- Calculs avec les tribus engendrées {#calculs-avec-les-tribus-engendrées .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Calculs avec les tribus engendrées}`{=latex}
...
::: {.section}
#### Exercice -- Ouverts ou fermés {#ouverts-ou-fermés .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Ouverts ou fermés}`{=latex}
...
::: {.section}
#### Exercice -- Tribu engendrée par les pavés compacts {#tribu-engendrée-par-les-pavés-compacts .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Tribu engendrée par les pavés compacts}`{=latex}

Montrer que la tribu engendrée par la collection des pavés compacts
$[a_1, b_1] \times \dots \times [a_n, b_n]$ de $\mathbb{R}^n$ est la
tribu de Borel de $\mathbb{R}^n$. (indication[^7])
:::
...
::: {.section}
#### Exercice -- Fonctions croissantes {#fonctions-croissantes .exercise .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Fonctions croissantes}`{=latex}
...
::: {.section}
#### Question 1 ($\mathord{\bullet}$) {#is-1 .question .one .unnumbered .unlisted}
...
::: {.section}
#### Question 2 ($\mathord{\bullet}\mathord{\bullet}$) {#is-2 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 3 ($\mathord{\bullet}\mathord{\bullet}$) {#is-3 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 4 ($\mathord{\bullet}\mathord{\bullet}$) {#is-4 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 1 ($\mathord{\bullet}\mathord{\bullet}$) {#mdi-1 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 2 ($\mathord{\bullet}\mathord{\bullet}$) {#mdi-2 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 0 ($\mathord{\bullet}\mathord{\bullet}$) {#mim-0 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 1 ($\mathord{\bullet}$) {#mim-1 .question .one .unnumbered .unlisted}
...
::: {.section}
#### Question 2 ($\mathord{\bullet}$) {#mim-2 .question .one .unnumbered .unlisted}
...
::: {.section}
#### Question 3 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#mim-3 .question .three .unnumbered .unlisted}
...
::: {.section}
#### Question 1 ($\mathord{\bullet}\mathord{\bullet}$) {#cm-1 .question .two .unnumbered .unlisted}
...
::: {.section}
#### Question 2 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#cm-2 .question .three .unnumbered .unlisted}
...
::: {.section}
#### Question 1 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#enm-1 .question .four .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Montrer qu'il existe un ensemble $\lambda^*$-mesurable $B$ contenant $A$
et tel que $\lambda^*(A) = \lambda^*(B)$. ([Solution p.
`\pageref*{answer-enm-1}`{=tex}](#answer-enm-1){.no-parenthesis}.)
:::

::: {.section}
#### Question 2 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#enm-2 .question .four .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 2}`{=latex}

A quelle condition portant sur $\lambda^*(B \setminus A)$ l'ensemble $A$
est-il $\lambda^*$-mesurable ? ([Solution p.
...
$$ où $\lambda^*$ désigne la mesure extérieure de Lebesgue sur
$\mathbb{R}^n$.

::: {.section}
#### Question 1 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#mi-1 .question .four .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Montrer que la définition de $\lambda_*(A)$ ne dépend pas du choix du
pavé $P$. ([Solution p.
`\pageref*{answer-mi-1}`{=tex}](#answer-mi-1){.no-parenthesis}.)
:::

::: {.section}
#### Question 2 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#mi-2 .question .four .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 2}`{=latex}

Montrer que $\lambda_*(A) \leq \lambda^*(A)$, avec égalité si $A$ est
$\lambda^*$-mesurable. ([Solution p.
`\pageref*{answer-mi-2}`{=tex}](#answer-mi-2){.no-parenthesis}.)
:::

::: {.section}
#### Question 3 ($\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}\mathord{\bullet}$) {#mi-3 .question .four .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 3}`{=latex}

Montrer la réciproque de la question précédente : si
$A \subset \mathbb{R}^n$ est borné et $\lambda_*(A) = \lambda^*(A)$,
alors $A$ est $\lambda^*$-mesurable. ([Solution p.
...
::: {.section}
#### Ensemble des parties {#answer-parties .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Ensemble des parties}`{=latex}

Comme $A \in \mathcal{A} := \mathcal{P}(X)$ si et seulement si
$A \subset X$, prouver que $\mathcal{A}$ est une tribu de $X$ équivaut à
établir
...
3.  Si pour tout $k \in \mathbb{N}$, $A_k \subset X$, alors
...
::: {.section}
#### Ensembles fermés {#answer-fermés .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Ensembles fermés}`{=latex}

Non. Par exmemle, le singleton $\{0\}$ est un ensemble fermé de
$\mathbb{R}^n$, mais son complémentaire $\mathbb{R}^n \setminus \{0\}$
n'est pas fermé.
:::

::: {.section}
#### Tribu née sous $X$ {#answer-X .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Tribu née sous \(X\)}`{=latex}

Il suffit de chercher "le plus grand" ensemble (avec comme relation
d'ordre l'inclusion) dans la collection $\mathcal{A}$. En effet, tous
les ensembles $A$ de $\mathcal{A}$ sont inclus dans $X$ ; de plus
$\varnothing \in \mathcal{A}$ et comme la tribu $\mathcal{A}$ est fermée
par passage au complémentaire,
$X \setminus \varnothing = X \in \mathcal{A}$.
:::

::: {.section}
#### Opérations ensemblistes {#answer-op-ens .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Opérations ensemblistes}`{=latex}

Soient $A$ et $B$ des ensembles de $\mathcal{A}$. La suite
$(A_k)_{k\in \mathbb{N}}$ définie par $A_0 = A$, $A_1 = B$ et
$A_k = \varnothing$ si $k \geq 2$ est composée d'ensembles de
$\mathcal{A}$. Or, $\cup_{k \in N} A_k = A \cup B$ donc
$A \cup B \in \mathcal{A}$. L'ensemble $A \cap B$ vérifie
$A \cap B = X \setminus ((X \setminus A) \cup (X \setminus B))$, il
appartient donc également à $\mathcal{A}$. Finalement, on a
$A \setminus B = A \cap (X \setminus B)$, donc $A \setminus B$
appartient également à $\mathcal{A}$.
:::

::: {.section}
#### Intersection dénombrable {#answer-id .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Intersection dénombrable}`{=latex}

Si pour tout $k \in \mathbb{N}$ on a $A_k \in X$, alors comme la tribu
$\mathcal{A}$ est fermée par complémentation,
$X \setminus A_k \in \mathcal{A}$. Comme $\mathcal{A}$ est fermée par
union dénombrable, $\cup_{k=0}^{+\infty} A_k \in \mathcal{A}$ ; son
complémentaire dans $X$ appartient donc également à $\mathcal{A}$. Or,
$$
...
::: {.section}
#### Intersection de tribus I {#answer-it1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Intersection de tribus I}`{=latex}

1.  $\varnothing \in \mathcal{A}_1$ et $\varnothing \in \mathcal{A}_2$
    donc $\varnothing \in \mathcal{A}_1 \cap \mathcal{A}_2$.

2.  Si $A \in \mathcal{A}_1$ et $A \in \mathcal{A}_2$, alors
    $A^c \in \mathcal{A}_1$ et $A^c \in \mathcal{A}_2$, donc
    $A^c \in \mathcal{A}_1 \cap \mathcal{A}_2$.

3.  Si pour tout $k \in \mathbb{N}$, $A_k \in \mathcal{A}_1$ et
    $A_k \in \mathcal{A}_2$ alors
    $\cup_{k=0}^{+\infty} A_k \in \mathcal{A}_1$ et
    $\cup_{k=0}^{+\infty} A_k \in \mathcal{A}_2$, donc
    $\cup_{k=0}^{+\infty} A_k \in \mathcal{A}_1 \cap \mathcal{A}_2.$
:::

::: {.section}
#### Intersection de tribus II {#answer-it2 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Intersection de tribus II}`{=latex}

La collection $\mathcal{A} := \cap_{i \in I} \mathcal{A}_{i \in I}$ est
une tribu quel que soit l'ensemble d'indexation $I$ et sa cardinalité.
En effet :
...
3.  Si pour tout $k \in \mathbb{N}$, $A_k \in \mathcal{A}_i$ pour tout
    $i \in I$, alors $\cup_{k=0}^{+\infty} A_k \in \mathcal{A}_i$ pour
    tout $i \in I$, donc
    $\cup_{k=0}^{+\infty} A_k \in \cap_{i \in U} \mathcal{A}_i.$
:::

::: {.section}
#### Les mesures sont (finiment) additives {#answer-fa .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Les mesures sont (finiment) additives}`{=latex}

Etendons la suite finie des $A_k$ en posant $A_k = \varnothing$ quand
$k\geq n+1$. En combinant la $\sigma$-additivité de $\mu$ et sa nullité
en $0$, on obtient $$
...
::: {.section}
#### Monotonie {#answer-mono .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Monotonie}`{=latex}

L'ensemble $B \setminus A = B \cap A^c$ appartient à $\mathcal{A}$, est
disjoint de $A$ et son union avec $A$ est $B$. Donc [comme $\mu$ est
finiment additive (p. `\pageref*{fa}`{=tex})](#fa), on a $$
\mu(B) = \mu(A \cup (B \setminus A)) =  \mu(A) + \mu(B \setminus A).
$$ Comme $\mu(B \setminus A) \geq 0$, on en déduit que
$\mu(A) \leq \mu(B)$.
:::

::: {.section}
#### Cas dégénéré {#answer-degen .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Cas dégénéré}`{=latex}

Oui, il y a par exemple la fonction qui associe à tout ensemble
$A \in \mathcal{A}$ la valeur $\mu(A) = +\infty$. Si $\mu$ n'est pas
nulle en 0, par $\sigma$-additivité $$
\mu(\varnothing) 
...
::: {.section}
#### Ca commence par un $\mathbb{P}$ {#answer-P .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Ca commence par un \(\mathbb{P}\)}`{=latex}

La mesure $\mu$ est une probabilité. En effet, comme $\mu(X)=1$, [par
monotonie de la mesure (p. `\pageref*{mono}`{=tex})](#mono), pour tout
$A \in \mathcal{A}$, comme $A \subset X$, $\mu(A) \leq 1$. Donc, comme
toute mesure est positive, $\mu(A) \in [0,1]$. La mesure $\mu$ est
également $\sigma$-additive ; c'est donc une (mesure de) probabilité.
Réciproquement, toute probabilité est une mesure : elle est positive,
$\sigma$-additive, et comme elle est finie, $$
\mathbb{P}(\varnothing) 
= \mathbb{P}\left(\bigcup_{k=0}^{+\infty} \varnothing \right)
= \sum_{k=0}\mathbb{P}(\varnothing),
$$ donc nécessairement $\mathbb{P}(\varnothing)= 0$ ; elle est donc
nulle en $0$ et c'est bien une mesure.
:::

::: {.section}
#### Trace d'une mesure {#answer-trace .answer .unnumbered .unlisted}
...
$$ donc $\mu|_A$ est nulle en 0. Finalement, si les ensembles $A_k$,
$k \in \mathbb{N}$ de $\mathcal{A}$ sont disjoints deux à deux, alors
les ensembles $A \cap A_k$ sont également disjoints deux à deux donc
`\begin{align*}
...
\end{align*}`{=tex} La fonction $\mu|_A$ est donc une mesure sur
$(X, \mathcal{A})$.
:::

::: {.section}
#### Somme de mesures {#answer-somme .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Somme de mesures}`{=latex}

On a bien $\mu_1 + \mu_2 : \mathcal{A} \to [0, +\infty]$. De plus, $$
(\mu_1 + \mu_2)(\varnothing) = \mu_1(\varnothing) + \mu_2(\varnothing) = 0 + 0 =0.
$$ Finalement, si la suite $A_k \in \mathcal{A}$, $k \in \mathbb{N}$ est
formée d'ensembles deux à deux disjoints, alors `\begin{align*}
...
::: {.section}
#### Mesure de Dirac {#answer-dirac .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Mesure de Dirac}`{=latex}

Comme pour tout $x \in X$, on $x \not \in \varnothing$, il s'ensuit que
$\delta_x(\varnothing)=0$. De plus, si les $A_k$ ($k \in \mathbb{N}$)
sont des sous-ensembles de $X$ disjoints deux à deux, soit aucun d'entre
eux ne contient $x$, auquel cas $$
...
::: {.section}
#### Et en changeant de point de vue ? {#answer-ptdevue .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Et en changeant de point de vue ?}`{=latex}

Comme $\delta_x(A) = 1$ si $x\in A$ et $0$ sinon, on a
$\delta_x(A) = 1_A(x)$.
:::

::: {.section}
#### Mesure de comptage {#answer-ct .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Mesure de comptage}`{=latex}

Commen l'ensemble vide ne contient aucun élément, on a
$c(\varnothing) = 0$. De plus, si les ensembles $A_k$
($k \in \mathbb{N}$) sont disjoints deux à deux, alors le nombre -- fini
ou infini -- d'éléments distincts de $\cup_{k=0}^{+\infty} A_k$ est la
somme des éléments des $A_k$, c'est-à-dire $$
c\left(\bigcup_{k=0}^{+\infty} A_k \right) = \sum_{k=0}^{+\infty} c(A_k).
$$ La mesure de comptage est bien une mesure.
:::

::: {.section}
#### Négligeable pour la mesure de comptage {#answer-nmc .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Négligeable pour la mesure de comptage}`{=latex}

Un ensemble $A \subset \mathcal{P}(X)$ est de mesure de comptage nulle
si et seulement s'il est vide. Donc il existe un unique ensemble contenu
dans un ensemble de mesure nulle : l'ensemble vide.
:::

::: {.section}
#### Négligeable pour la mesure de Dirac {#answer-nmd .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Négligeable pour la mesure de Dirac}`{=latex}

Un ensemble $A \subset \mathcal{P}(X)$ est de mesure de Dirac en $x$
nulle si et seulement s'il ne contient pas $x$. Un ensemble $N$ peut
être inclus dans un tel ensemble $A$ si et seulement s'il ne contient
pas lui-même le point $x$. Donc un ensemble est $\delta_x$-négligeable
si et seulement s'il ne contient pas $x$.
:::

::: {.section}
#### Négligeable et mesurable {#answer-nem .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Négligeable et mesurable}`{=latex}

Si $N$ est mesurable et de mesure nulle, alors $N \subset N$ et
$\mu(N)=0$ ; $N$ est donc négligeable. Réciproquement, si un ensemble
$N$ est négligeable et mesurable alors $N \in \mathcal{A}$ et il existe
$A \in \mathcal{A}$ tel que $N \subset A$ et $\mu(A) = 0$. [Comme $\mu$
est monotone (p. `\pageref*{mono}`{=tex})](#mono), on a également
$\mu(N) = 0$ ; $N$ est donc de mesure nulle.
:::

::: {.section}
#### Mesurabilité et ensemble des parties de $X$ {#answer-pm .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Mesurabilité et ensemble des parties de \(X\)}`{=latex}

Toutes les fonctions $f: X \to [-\infty, +\infty]$ sont
$\mathcal{A}$-mesurables. En effet, l'image réciproque de tout fermé par
$f$ appartient bien à $\mathcal{A}$ puisque $\mathcal{A}$ contient tous
les sous-ensembles de $X$.
:::

::: {.section}
#### Fonction caractéristique {#answer-fc .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Fonction caractéristique}`{=latex}

A la condition que $A \in \mathcal{A}$, c'est-à-dire que $A$ soit
mesurable. En effet, si $f$ est mesurable, alors comme
$A = f^{-1}(\{1\})$, il est nécessaire que $A$ soit mesurable.
Réciproquement, si $A$ est mesurable, quel que soit $F$ fermé de
$[-\infty, +\infty]$, en énumérant les cas, et selon que $0$ et $1$
appartiennent ou non à $F$, on réalise que $f^{-1}(F)$ est l'un des 4
ensembles suivants : $\varnothing$, $A$, $A^c$, ou $X$. Dans tous les
cas, $f^{-1}(F)$ est mesurable.
:::

::: {.section}
#### Trace de fonction {#answer-trace-mesurable .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Trace de fonction}`{=latex}

[La fonction $f$ peut être approximée par des fonctions étagées
positives (p. `\pageref*{app-fep}`{=tex})](#app-fep) : elle est la
limite simple d'une suite de fonctions $f_j$ ($j \in \mathbb{N}$) de la
forme $$
f_j = \sum_{k=1}^{n_j} y_k^j 1_{A_k^j},
$$ où les ensembles $A_k^j$ sont mesurables et les réels $y_k^j$
positifs. Comme $A$ est mesurable, pour tout $j$ et $k$, l'ensemble
$A \cap A_k^j$ est mesurable et donc les fonctions $$
1_A f_j = \sum_{k=1}^{n_j} y_k^j 1_{A \cap A_{k}^j}
$$ sont également mesurables. Elles convergent simplement vers $1_A f$
quand $j$ tend vers $+\infty$ ; [par conséquent (p.
`\pageref*{limite-simple}`{=tex})](#limite-simple), la fonction $1_A f$
est mesurable.
:::

::: {.section}
#### Somme de fonctions {#answer-somme-mesurable .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Somme de fonctions}`{=latex}

[Les fonctions $f$ et $g$ peuvent être approximées par des fonctions
étagées positives (p. `\pageref*{app-fep}`{=tex})](#app-fep) : elle sont
les limites simples de suites de fonctions $f_j$ et $g_j$
($j \in \mathbb{N}$) de la forme $$
f_j = \sum_{k=1}^{n_j} y_k^j 1_{A_k^j} \; \mbox{ et } \; g_j = \sum_{l=1}^{m_j} z_l^j 1_{B_l^j}
$$ où les ensembles $A_k^j$ et $B_l^j$ sont mesurables et les réels
$y_k^j$ et $z_l^j$ sont positifs. La somme $$
f_j + g_j = \sum_{k=1}^{n_j} y_k^j 1_{A_k^j} + \sum_{l=1}^{m_j} z_l^j 1_{B_l^j}
$$ est (étagée positive et) mesurable (elle s'écrit comme une somme
pondérée par des coefficients réels positifs des fonctions
caractéristiques des ensembles $A_k^j \cap B_l^j$). De plus la suite
$f_j + g_j$ converge simplement vers $f + g$ quand $j$ tend vers
$+\infty$ ; [par conséquent (p.
`\pageref*{limite-simple}`{=tex})](#limite-simple), la fonction $f + g$
est mesurable.
:::

::: {.section}
#### Calculs et infinis {#answer-inf .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Calculs et infinis}`{=latex}

La somme pose un problème quand $f(x) = +\infty$ et $g(x) = -\infty$ (ou
la situation inverse). Le produit n'est pas non plus défini quand l'un
des termes est nul et l'autre est infini. Par contre, le maximum de
$f(x)$ et de $g(x)$ est toujours bien défini, même si $f$ et $g$
prennent leur valeurs dans $[-\infty, +\infty]$.
:::

::: {.section}
#### Combinaison linéaire {#answer-cl .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Combinaison linéaire}`{=latex}

La fonction
$x \in [-\infty, +\infty] \to \lambda x \in [-\infty, +\infty]$ est bien
définie et continue, donc $\lambda f$ est mesurable [par composition par
une fonction continue (p. `\pageref*{cpfc}`{=tex})](#cpfc).
...
est bien définie et contine donc $f+g$ est continue [par composition par
une fonction continue (p. `\pageref*{cpfc}`{=tex})](#cpfc).
:::

::: {.section}
#### Intégrale et mesures de Dirac {#answer-imd .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Intégrale et mesures de Dirac}`{=latex}

Pour tout $j \in \mathbb{N}$, $f_j$ peut s'écrire comme
$f_j= \sum_{k=1}^n y_k 1_{A_k}$, où $y_k > 0$ et
$A_k \in \mathcal{P}(\mathbb{R})$. Donc, en utilisant successivement la
linéarité de l'intégrale et le lien entre intégrale et mesure, on
obtient $$
\int f_j \, \delta_x 
...
$$ Par conséquent, comme $f_j(x) \to f(x)$ quand $j \to +\infty$, la
propriété de convergence monotone garantit que $$
\int f \, \delta_x = f(x).
$$
:::

::: {.section}
#### Absolue intégrabilité {#answer-AI .answer .unnumbered .unlisted}
...
::: {.section}
#### Intégrabilité de fonctions étagées {#answer-feAI .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Intégrabilité de fonctions étagées}`{=latex}

Notons $(y_{k})_+ = \max(y_k, 0)$ et $(y_{k})_- = -\min(y_k, 0)$ ; les
parties positives et négatives de $f$ se mettent sous la forme $$
...
\; \mbox{ et } \;
\int f_- \, \mu = \sum_k (y_{k})_- \, \mu(A_k) < + \infty
$$ ou de façon équivalente si leur somme est finie, ce qui se réécrit
comme $$
\sum_k (y_{k})_+ \, \mu(A_k) 
+
\sum_k (y_{k})_- \, \mu(A_k)
...
::: {.section}
#### Vers l'indéfini et au-delà {#answer-ied .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Vers l'indéfini et au-delà}`{=latex}

On peut considérer (une des définitions de) la fonction signe
$f: \mathbb{R}\to \mathbb{R}$, caractérisée par $f(x) = -1$ si $x<0$,
$f(0)= 0$ et $f(x)=1$ si $x>1$. La fonction $f$ est continue par
morceaux, donc "classiquement" mesurable, c'est-à-dire mesurable pour la
tribu de Lebesgue. En examinant successivement $f_+$ est $f_-$ on peut
se convaincre que ces fonctions (qui sont étagées) ont pour intégrales
(par rapport à la mesure de Lebesgue) $+\infty$ ; la fonction $f$ n'est
donc pas intégrable.
:::
...
$\lim_{k \to +\infty} f_k(n) = f(n)$. La propriété de convergence
monotone de l'intégrale nous assure alors que $$
...
::: {.section}
#### Question 3 {#answer-is-3 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 3}`{=latex}

Toute fonction $f:\mathbb{N}\to [-\infty, +\infty]$ est
$\mathcal{P}(\mathbb{N})$-mesurable. Elle est $c$-intégrable si $f_+$ et
$f_-$ ont des intégrales finies, c'est-à-dire si $$
...
$$ autrement dit si et seulement si la suite des $f(n)$ est absolument
...
::: {.section}
#### Question 4 {#answer-is-4 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 4}`{=latex}

Le théorème de convergence dominée dans le cas de la mesure de comptage
$c$ sur $\mathbb{N}$ devient le résultat suivant sur les (suites de)
séries :

Soit $f_k: \mathbb{N}\to [-\infty, +\infty]$, $k \in \mathbb{N}$, une
suite de fonctions dominées par la fonction intégrable
$g: \mathbb{N}\to [0, +\infty]$ c'est-à-dire telles que pour tout tout
$k \in \mathbb{N}$ et tout $n \in \mathbb{N}$, $$
0 \leq |f_k(n)| \leq g(n) \; \mbox{ et } \; \sum_{n=0}^{+\infty} g(n) < +\infty.
$$ Si pour tout $n \in \mathbb{N}$,
$f_k(n) \to f(n) \mbox{ quand } k \to +\infty,$ alors $$
...
::: {.section}
#### Question 1 {#answer-mdi-1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Pour tout $A \in \mathcal{A}$, la fonction $1_A$ est mesurable, car
l'image réciproque par $1_A$ d'un ouvert de $[0, +\infty]$ est soit $A$
soit $\varnothing$. Si $f: X \to \left[0, +\infty\right[$ est mesurable,
...
::: {.section}
#### Question 2 {#answer-mdi-2 .answer .unnumbered .unlisted}
...
Si les ensembles de la suite $(A_k)_{k \in N}$ sont mesurables et
disjoints, les fonctions $$
g_k = 1_{\cup_{j=0}^k A_k} = \sum_{j=0}^k 1_{A_k}
$$ forment une suite croissante de fonctions mesurables et $g_k f$
converge simplement vers $1_{\cup_{k=0}^{+\infty} A_k} f$. Par le
théorème de croissance monotone, on a donc $$
...
$$ La fonction $f \mu$ est donc $\sigma$-additive. C'est donc une mesure
sur $(X,\mathcal{A})$.
:::
:::
...
::: {.section}
#### Question 0 {#answer-mim-0 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 0}`{=latex}

Pour tout $A \subset \mathbb{R}$,
$h^{-1}(A) \cap \left]-1, 1\right[ = A \cap \left]-1, 1\right[,$
$h^{-1}(A) \cap \left]-\infty, -1\right] = \left]-\infty, -1\right]$ ou
$\varnothing$ selon que $-1$ appartienne ou non à $A$ et
$h^{-1}(A) \cap \left[+1, +\infty\right[ = \left[+1, +\infty\right[$ ou
$\varnothing$ selon que $+1$ appartienne ou non à $A$.

Par conséquent, si $A \in \mathcal{L}(\mathbb{R})$, l'ensemble
$$h^{-1}(A) = (h^{-1}(A) \cap \left]-\infty, -1\right]) \cup (h^{-1}(A) \cap \left]-1, 1\right[)   \cup (h^{-1}(A) \cap \left[+1, +\infty\right[)$$
est l'union de trois ensembles de $\mathcal{L}(\mathbb{R})$ ; il
appartient donc à $\mathcal{L}(\mathbb{R})$ et la fonction $\nu$ est
bien définie.

En utilisant l'additivité de $\mu$, on constate alors que $$
\nu(A) = \mu(h^{-1}(A)) = \alpha \delta_{-1}(A) + \mu|_{\left]-1,1\right[} (A) + \beta \delta_{1}(A)
$$ où $\alpha= \mu(\left]-\infty, -1\right])$,
$\beta = \mu(\left[+1, +\infty\right[)$ et $\mu|_{\left]-1,1\right[}$
est la mesure trace de $\mu$ sur $\left]-1,1\right[$, définie par
$\mu|_{\left]-1,1\right[} (A) = \mu(\left]-1,1\right[ \cap A)$. La
fonction $\nu(A)$ est donc une mesure sur
$(\mathbb{R}, \mathcal{L}(\mathbb{R}))$ comme somme de trois mesures sur
$(\mathbb{R}, \mathcal{L}(\mathbb{R}))$.
:::

::: {.section}
#### Question 1 {#answer-mim-1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

L'ensemble $\mathcal{B}$ est une tribu ; en effet :

-   $\varnothing \in \mathcal{A}$ et
    $\varnothing = h^{-1}(\varnothing)$, donc
    $\varnothing \in \mathcal{B}$.

-   Si $B \in \mathcal{B}$, l'ensemble $A = h^{-1}(B)$ appartient à
    $\mathcal{A}$. Le complémentaire $Y \setminus B$ de $B$ dans $Y$
    vérifie
    $h^{-1}(Y \setminus B) = X \setminus h^{-1}(B) = X \setminus A$ et
    appartient donc à $\mathcal{A}$. L'ensemble $Y \setminus B$
    appartient donc à $\mathcal{B}$.

-   Si les ensembles $B_k$, $k \in \mathbb{N}$ appartiennent à
    $\mathcal{B}$, comme $h^{-1}(\cup_k B_k) = \cup_k h^{-1}(B_k)$, cet
    ensemble appartient à $\mathcal{A}$. L'union dénombrable
    $\cup_k B_k$ appartient donc à $\mathcal{B}$.
:::

::: {.section}
#### Question 2 {#answer-mim-2 .answer .unnumbered .unlisted}
...
-   On a
    $\mu\circ h^{-1}(\varnothing) = \mu(h^{-1}(\varnothing)) = \mu(\varnothing) = 0$.

-   Si les ensembles $B_k$, $k \in \mathbb{N}$, appartiennent à
    $\mathcal{B}$ et sont disjoints, alors les ensembles $h^{-1}(B_k)$
    appartiennent à $\mathcal{A}$, et sont disjoints. Comme
    $h^{-1}(\cup_k B_k) = \cup_k h^{-1}(B_k)$, on a $$
    \begin{split}
...
::: {.section}
#### Question 3 {#answer-mim-3 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 3}`{=latex}

Montrons tout d'abord que la fonction $f:Y \to [-\infty,+\infty]$ est
$\mathcal{B}$-mesurable si et seulement si $f \circ h$ est
$\mathcal{A}$-mesurable. Par définition, $f$ est mesurable si pour tout
ouvert $U$ de $\mathbb{R}$, l'ensemble $f^{-1}(U)$ appartient
$\mathcal{B}$, c'est-à-dire si et seulement si $$
h^{-1} (f^{-1}(U)) = (f \circ h)^{-1}(U) \in \mathcal{A},
$$ c'est-à-dire si et seulement si $f \circ h$ est mesurable.

Comme $(f \circ h)_+ = f_+ \circ h$ et $(f \circ h)_- = f_- \circ h$, il
nous suffit de montrer que pour toute fonction mesurable
$f: Y \to \left[0, +\infty\right]$, on a $$
\int (f \circ h) \mu = \int f (\mu \circ h^{-1})
$$ pour pouvoir conclure que $f: Y \to [-\infty,+\infty]$ est
$\mu \circ h^{-1}$-intégrable si et seulement si $f \circ h$ est
$\mu$-intégrable et que l'égalité ci-dessus est valable également dans
le cas des fonctions signées.

Or pour une telle fonction positive $f$, il existe une suite croissante
de fonctions $f_k$ étagées, positives et mesurables convergeant
simplement vers $f$, et l'on a $$
\int f (\mu \circ h^{-1}) 
=
...
leur suite est croissante et converge simplement vers $f \circ h$. [Par
le théorème de convergence monotone (p. `\pageref*{TCM}`{=tex})](#TCM),
on a donc comme souhaité $$
\int f \, (\mu \circ h^{-1}) 
=
\int (f \circ h) \, \mu.
$$
...
::: {.section}
#### Question 1 {#answer-cm-1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Il est clair que $\varnothing$ appartient à $\overline{\mathcal{A}}$,
comme différence symétrique entre $\varnothing$ et $\varnothing$. Si
$B = A \mathbin{\Delta}N$ appartient à $\overline{\mathcal{A}}$, alors
$$
B^c = ((A \cap N^c) \cup (A^c \cap N))^c = (A^c \cup N) \cap (A \cup N^c).
$$ Comme $B^c = X \cap B^c = (A \cup A^c) \cap B^c$, par distributivité
on a $$
\begin{split}
...
Si les $A_k$, $k \in \mathbb{N}$, appartiennent $\mathcal{A}$ et les
$N_k$, $k \in \mathbb{N}$, appartiennent à $\mathcal{N}$, alors on
pourra se convaincre que $$
(\cup_k A_k) \setminus (\cup_k N_k) 
\subset \cup_{k} (A_k \mathbin{\Delta}N_k)
\subset (\cup_k A_k) \cup (\cup_k N_k),
$$ ce qui prouve que $$
\cup_k (A_k \mathbin{\Delta}N_k) = (\cup_k A_k) \mathbin{\Delta}M 
\; \mbox{ avec } \;
...
Comme $\cup_k A_k \in \mathcal{A}$, on en déduit que
$\overline{\mathcal{A}}$ est stable par union dénombrable. Cet
collection contient l'ensemble vide, est fermé par passage au
complémentaire et par union dénombrable ; c'est donc une tribu.
:::

::: {.section}
#### Question 2 {#answer-cm-2 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 2}`{=latex}

Supposons que $\overline{\mu}$ soit une mesure sur
$\overline{\mathcal{A}}$ qui prolonge $\mu$. Alors, nécessairement, pour
tout ensemble $N \in \mathcal{N}$, on a $\overline{\mu}(N) = 0$. En
effet, il existe un $A \in \mathcal{A}$ tel que $N \subset A$ et
$\mu(A) = 0$, donc par croissance de $\overline{\mu}$, $$
...
\overline{\mu}(A \mathbin{\Delta}N) = \overline{\mu}((A \setminus N_1) \cup N_2)
= \overline{\mu}(A) - \overline{\mu}(N_1) + \overline{\mu}(N_2)
= \overline{\mu}(A).
$$ Cette équation définit uniquement $\overline{\mu}$ ; il faut
toutefois s'assurer que cette définition est cohérente, c'est-à-dire que
si $A \mathbin{\Delta}N = B \mathbin{\Delta}M$ où $A, B \in \mathcal{A}$
et $N, M \in \mathcal{N}$, alors $\mu(A) = \mu(B)$. En utilisant
l'associativité de $\mathbin{\Delta}$, on montre que $$
A \mathbin{\Delta}(N \mathbin{\Delta}M) = (A \mathbin{\Delta}N) \mathbin{\Delta}M = (B \mathbin{\Delta}M) \mathbin{\Delta}M = B \mathbin{\Delta}(M \mathbin{\Delta}M) = B.
$$ Par conséquent, $N \mathbin{\Delta}M \in \mathcal{A}$, et comme
$N \mathbin{\Delta}M \subset N \cup M$, on en déduit que
$\mu(N \mathbin{\Delta}M) = 0$, et donc $$
\mu(B) = \mu(A) - \mu(A \cap (N \mathbin{\Delta}M)) + \mu(A^c \cap (N \mathbin{\Delta}M)) = \mu(A).
$$

Il est ensuite nécessaire de prouver que $\overline{\mu}$ est bien une
mesure. Soit $A_k \in \mathcal{A}$ et $N_k \in \mathcal{N}$ deux suites
d'ensembles tels que les $A_k \mathbin{\Delta}N_k$ soient deux à deux
disjoints. Soit $M_k$ un ensemble de $\mathcal{A}$ contenant $N_k$ et
tel que $\mu(M_k) = 0$. L'ensemble $B_k := A_k \setminus M_k$ appartient
$\mathcal{A}$ et $\mu(B_k) = \mu(A_k)$ ; de plus, comme
$B_k \subset A_k \mathbin{\Delta}N_k$, les $B_k$ sont disjoints deux à
deux. On a déjà vu à la question précédente que $$
\overline{\mu}(\cup_k A_k \mathbin{\Delta}N_k)
= \overline{\mu}((\cup_k A_k) \mathbin{\Delta}N) \; \mbox{ où } \, N \in \mathcal{N},
$$ donc $$
\begin{split}
\overline{\mu}(\cup_k A_k \mathbin{\Delta}N_k)
&= \mu(\cup_k A_k) = \mu(\cup_k B_k) \\
&= \sum_k \mu(B_k) = \sum_k \mu(A_k) = \sum_k \overline{\mu}(A_k \mathbin{\Delta}N_k).
\end{split}
...
::: {.section}
#### Question 1 {#answer-enm-1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Par définition de $\lambda^*(A)$, pour tout $j \in \mathbb{N}$, il
existe une collection dénombrable de pavés $P^j_k$ tels que $$
\lambda^*(A) \leq \sum_{k=0}^{+\infty} \lambda(P^j_k) \leq \lambda^*(A) + 2^{-j}.
$$ Les ensembles $B_j = \cup_k P^j_k$ sont $\lambda^*$-mesurables comme
unions dénombrables d'ensembles mesurables. De plus, comme
$A \subset B_j$, et par $\sigma$-subadditivité de $\lambda^*$ $$
\lambda^*(A) 
\leq \lambda^*(B_j) 
\leq \sum_{k=0}^{+\infty} \lambda^*(P^j_k)
\leq \sum_{k=0}^{+\infty} \lambda(P^j_k) \leq \lambda^*(A) + 2^{-j}.
$$ L'intersection $B = \cap_j B_j$ est un ensemble mesurable qui
recouvre $A$ et est contenu dans chaque $B_j$ ; par conséquent pour tout
$j \in \mathbb{N}$, $$
\lambda^*(A) \leq \lambda(B) \leq \lambda(B_j) \leq \lambda^*(A) + 2^{-j}.
$$ On en déduit donc que $A \subset B$ et $\lambda^*(A) = \lambda^*(B)$
avec $B$ mesurable.
:::

::: {.section}
#### Question 2 {#answer-enm-2 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 2}`{=latex}

Notons au préalable que si $\lambda^*(A) = +\infty$, alors $A$ est
automatiquement mesurable. Dans le cas contraire
($\lambda^*(A) < +\infty$) l'ensemble $A$ est $\lambda^*$-mesurable si
et seulement si $\lambda^*(B \setminus A) = 0$. En effet, si $A$ est
$\lambda^*$-mesurable et de mesure finie, comme $A \subset B$, on a $$
\lambda^*(B) = \lambda^*(A \cap B) + \lambda^*(A^c \cap B) = \lambda^*(A) + \lambda^*(B \setminus A) = \lambda^*(B) + \lambda^*(B \setminus A).
$$ Comme la mesure $\lambda^*(A)$ est finie,
$\lambda^*(B \setminus A) = 0$. Réciproquement, si
$\lambda^*(B \setminus A) = 0$, alors $B \setminus A$ (et donc $A$) est
mesurable. En effet, pour tout ensemble $C$ de $\mathbb{R}^n$, on a
d'une part $$
\lambda^*(C) \leq \lambda^*((B \setminus A) \cap C) + \lambda^*((B \setminus A)^c \cap C) 
$$ par subbadditivité de $\lambda^*$. D'autre part, comme
$(B \setminus A) \cap C \subset B \setminus A$,
...
$$ On a donc l'égalité
$\lambda^*(C) = \lambda^*((B \setminus A) \cap C) + \lambda^*((B \setminus A)^c \cap C)$ ;
l'ensemble $B \setminus A$ est donc mesurable, ainsi que
...
::: {.section}
#### Question 1 {#answer-mi-1 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 1}`{=latex}

Pour montrer que la définition de $\lambda_*(A)$ ne dépend pas du choix
du pavé $P$ contenant $A$, il suffit de prouver qu'on peut remplacer $P$
par un pavé compact $P'$ contenant $P$ sans changer la valeur de
$\lambda_*(A)$ (pour toute paire de pavés compacts on peut en effet
trouver un pavé compact les contenant).

Comme les pavés compacts $P$ et $P'$ sont mesurables (au sens de
Carathéodory, pour la mesure extérieure $\lambda^*$), l'ensemble
$P' \setminus P$ l'est également ; on a donc $$
...
::: {.section}
#### Question 2 {#answer-mi-2 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 2}`{=latex}

La fonction $\lambda^*$ étant subadditive, on a $$
\lambda^*(P) \leq \lambda^*(A) + \lambda^*(P\setminus A)
$$ et donc $\lambda_*(A) \leq \lambda^*(A)$. Si $A$ est mesurable,
l'inégalité initiale devient une égalité et donc
$\lambda_*(A) = \lambda^*(A)$.
:::

::: {.section}
#### Question 3 {#answer-mi-3 .answer .unnumbered .unlisted}

`\addcontentsline{toc}{paragraph}{Question 3}`{=latex}

Montrons que la réciproque est également vraie. Soit $A$ un ensemble
borné de $\mathbb{R}^n$ tel que $\lambda_*(A) = \lambda^*(A)$, et soit
$B$ un ensemble quelconque de $\mathbb{R}^n$. Nous cherchons à établir
que $\lambda^*(B) = \lambda^*(A \cap B) + \lambda^*(A^c \cap B)$.
...
\end{split}
$$ Autrement dit, il nous suffit d'établir le résultat cherché quand $B$
est un ensemble de $\mathbb{R}^n$ contenu dans le pavé compact $P$.

Pour cela, nous exploitons les résultats de l'exercice "[Approximation
par des ensembles mesurables (p. `\pageref*{aem}`{=tex})](#aem)". A
l'ensemble $A$ on peut associer un sur-ensemble $\lambda^*$-mesurable
$B$ tel que $\lambda^*(A) = \lambda^*(B)$ ; quitte à remplacer $B$ par
...
\end{split}
$$ et donc $\lambda^*(B \setminus A) = 0$. Par les résultats de
l'exercice "[Approximation par des ensembles mesurables (p.
`\pageref*{aem}`{=tex})](#aem)", on en déduit que $A$ est mesurable.
:::
:::
:::
...
[^3]: c'est-à-dire que ces opérations, appliquées à des ensembles de
    $\mathcal{A}$, produisent des ensembles qui sont également dans
    $\mathcal{A}$.

[^4]: sauf à introduire un nouveau nombre "indéfini" $\bot$, absorbant
    pour l'addition, tel que $\bot = +\infty - \infty$ (le [NaN ou
    *not-a-number* des numériciens](https://en.wikipedia.org/wiki/NaN)
    est un concept très proche). Mais nous n'allons pas explorer cette
    piste ici.

[^5]: En effet, dans ce cas, comme pour toute fonction mesurable
    $f: X \to [0, +\infty]$, il existe une suite croissante de fonctions
    étagées mesurables positives $f_k : X \to \left[0, +\infty\right[$
    convergeant simplement vers $f$, notre définition de l'intégrale
    doit nécessairement vérifier $$
    \int f \mu \leq \sup_{g \in \mathcal{F}(f)} \int g \mu.
    $$ Réciproquement, si $g_k: X \to \left[0, +\infty\right[$ est une
    suite de fonctions étagées mesurables positives (à valeurs finies)
    inférieures à $f$ telles que $$
    \lim_{k\to+\infty} \int g_k \, \mu =  \sup_{g \in \mathcal{F}(f)} \int g \, \mu,
    $$ alors la suite $h_k = \max(g_0,\dots, g_k, f_k)$ est une suite
    croissante de fonctions étagées mesurables positives (à valeurs
    finies) convergeant vers $f$ mais supérieures à $g_k$ et vérifiant
    donc nécessairement $$
    \int f \, \mu = \lim_{k\to+\infty} \int h_k \, \mu \geq \sup_{g \in \mathcal{F}(f)} \int g \, \mu.
    $$

[^6]: Henri Lebesgue (1875-1941) était un mathématicien français et
    Constantin Carathéodory (1873-1950) un mathématicien grec entrenant
    des liens étroits avec l'Allemagne. Ils font partie des fondateurs
    de la théorie abstraite de la mesure qui conduit à un renouveau de
    la théorie de l'intégration au début du XXème siècle.

[^7]: Commencer par montrer que tout ouvert de $\mathbb{R}^n$ s'écrit
