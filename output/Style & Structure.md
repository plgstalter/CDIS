...
Les documents sources exploitent une variante du format
...
[^3]: voir en particulier [la remarque de Mattew
    ...
    concernant le manque de visibilité de l'italique dans les fontes
    sans sérif, qui fait pencher la balance en faveur du gras, d'autant
    que l'italique à déjà un rôle qui lui est propre.
